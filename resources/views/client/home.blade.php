      ...
      <div class="swiper-container home-slider-container default-slider-container">
        <div class="swiper-wrapper home-slider-wrapper slider-default">
          <div class="swiper-slide">
            <div class="slider-content-area slider-content-area-two" data-bg-img="assets/img/slider/banner-01.jpg">
              <div class="container">
                    ...
                    <div class="col-lg-5">
                      <div class="slider-content">
                        <div class="content">
                          ...
                          <div class="title-box">
                            <h2 class="title"><span class="font-weight-600" style="color: black">Phong cách mới, đẳng cấp mới</span></h2>
                            <h4 class="font-weight-400 text-white mb-4" style="color: black">Thiết kế đột phá cho bước đi tự tin</h4>
                          </div>
                          <div class="btn-box">
                            <a class="btn-slider" href="shop.html" style="color: black">Xem ngay</a>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="swiper-slide">
            <div class="slider-content-area slider-content-area-two" data-bg-img="assets/img/slider/banner-02.jpg">
              <div class="container">
                <div class="slider-container">
                  <div class="row justify-content-between align-items-center">
                    <div class="col-lg-5">
        ...
        <div class="row divider-wrap divider-style3">
          ...
          {{-- <div class="col-lg-6">
            <div class="divider-content">
              ...
              <p class="desc">Quần áo thời trang cho phong cách sống năng động</p>
